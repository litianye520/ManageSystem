  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:emplsoyee:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:emplsoyee:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:emplsoyee:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="emplsoyeeList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键Id" align="center" prop="eid" />
      ...
      <el-table-column label="家庭出生" align="center" prop="homeAddress" />
      <el-table-column label="人员类型" align="center" prop="personType" />
      <el-table-column label="政治面貌" align="center" prop="politic" />
      <el-table-column label="毕业院校及专业" align="center" prop="graduate" />
      <el-table-column label="学历" align="center" prop="education" />
      <el-table-column label="现任职务" align="center" prop="position" />
      <el-table-column label="技术职称" align="center" prop="technology" />
      <el-table-column label="学位" align="center" prop="degree" />
      <el-table-column label="籍贯" align="center" prop="nativePlace" />
      <el-table-column label="出生地" align="center" prop="birthplace" />
      <el-table-column label="家庭住址" align="center" prop="family" />
      <el-table-column label="邮编" align="center" prop="postcode" />
      <el-table-column label="入团时间" align="center" prop="joinDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.joinDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参加工作时间" align="center" prop="workDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.workDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="学号" align="center" prop="jobNumber" />
      <el-table-column label="所在党组织" align="center" prop="organId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="姓名" prop="userUame">
          <el-input v-model="form.userUame" placeholder="请输入姓名" />
        </el-form-item>
        <el-form-item label="性别" prop="gender">
        ...
        <el-form-item label="曾用名" prop="nameUsed">
          <el-input v-model="form.nameUsed" placeholder="请输入曾用名" />
        </el-form-item>
        <el-form-item label="民族" prop="national">
        ...
        <el-form-item label="家庭出生" prop="homeAddress">
          <el-input v-model="form.homeAddress" placeholder="请输入家庭出生" />
        </el-form-item>
        <el-form-item label="人员类型" prop="personType">
        ...
        <el-form-item label="毕业院校及专业" prop="graduate">
          <el-input v-model="form.graduate" placeholder="请输入毕业院校及专业" />
        </el-form-item>
        <el-form-item label="学历" prop="education">
        ...
        <el-form-item label="技术职称" prop="technology">
          <el-input v-model="form.technology" placeholder="请输入技术职称" />
        </el-form-item>
        <el-form-item label="学位" prop="degree">
        ...
        <el-form-item label="家庭住址" prop="family">
          <el-input v-model="form.family" placeholder="请输入家庭住址" />
        </el-form-item>
        <el-form-item label="邮编" prop="postcode">
        ...
        <el-form-item label="所在党组织" prop="organId">
          <el-input v-model="form.organId" placeholder="请输入所在党组织" />
        </el-form-item>
        <el-form-item label="身份证号" prop="idCard">
